...
import { ProjectVersions } from "./project-versions.js";
...
export function ProjectBand({ project, knowledge, memory, detailErrors, rebuildBusy, archiveBusy, onEdit, onValidate, onRebuild, onArchive }: any) {
