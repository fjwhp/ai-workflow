...
function Dashboard({items,queues,queueFilter,onQueue,onClearFilter,onOpen}:any){const filterLabels:any={approvals:"待人工审批",ready:"AI 待启动",running:"AI 执行中",automation:"自动化待接管",blocked:"已阻塞"};return <div className="content"><section className="stats">
