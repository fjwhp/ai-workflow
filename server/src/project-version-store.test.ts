...
describe("project versions fresh schema", () => {
  it("owns branch and worktree state and removes the free integration target", () => {
    ...
    expect(schemaObjectNames(database, "index")).toEqual([
      ...
      "idx_delivery_application_unit_active",
      "idx_delivery_application_unit_history",
      "idx_delivery_application_version_active",
    ...
    expect(schemaObjectNames(database, "trigger").filter((name) => !name.startsWith("notify_delivery_event_"))).toEqual([
      ...
      "delivery_application_identity_immutable",
      "delivery_application_immutable_delete",
      "delivery_application_lease_transition",
      "delivery_application_settled_immutable",
      "delivery_application_source_transition",
      "delivery_application_status_transition",
      ...
      "delivery_unit_retry_audit_immutable_delete",
      "delivery_unit_retry_audit_immutable_update",
      ...
      "implementation_publication_cleanup_transition",
      "implementation_publication_identity_immutable",
      "implementation_publication_immutable_delete",
      "implementation_publication_status_transition",
      ...
      "validate_delivery_application_owner_insert",
      ...
      "validate_delivery_unit_retry_audit_insert",
